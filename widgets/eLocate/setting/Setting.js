    ...
    return declare([BaseWidgetSetting, _WidgetsInTemplateMixin], {
      ...
      setConfig: function(config) {
        ...
        setTimeout(function(){
          ...
          helpLink[0].href = 'http://gis.calhouncounty.org/WAB/V2.9/widgets/eLocate/help/eLocate_Help.htm';
        ...
        this.popupCoordsSR.set('value', this.config.coordinateWKID || this.map.spatialReference.wkid);
      ...
      getConfig: function() {
        ...
        this.config.coordinateWKID = this.popupCoordsSR.get('value');
      ...
      _onUnitEditOk: function() {
        ...
        if(this.popupState === 'ADD'){
          this.unitList.editRow(unitConfig[1], {
            ...
            tfwkid: unitConfig[0].tfwkid,
            tdirection: unitConfig[0].tdirection,
      ...
      _createUnit: function(args) {
        ...
        var rowData = {
          ...
          tfwkid: (args.config && args.config.tfwkid) || '',
          tdirection: (args.config && args.config.tdirection) || '',
